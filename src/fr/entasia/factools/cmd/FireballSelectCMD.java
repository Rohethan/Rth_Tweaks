...
public class FireballSelectCMD implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (p.hasMetadata("spellFireball")) {
            ...
            p.sendMessage("(§2Spells§f) Fireball §4désactivé");
        } else {
            p.setMetadata("spellFireball", new FixedMetadataValue(Main.main, true));
            p.sendMessage("(§2Spells§f) Fireball §2activé");
        }
        //desac autres spells

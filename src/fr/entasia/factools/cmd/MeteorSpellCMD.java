...
public class MeteorSpellCMD implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (p.hasMetadata("spellMeteor")) {
            ...
            p.sendMessage("(§2Spells§f) Meteor §4désactivé");
        } else {
            p.setMetadata("spellMeteor", new FixedMetadataValue(Main.main, true));
            p.sendMessage("(§2Spells§f) Meteor §2activé");
        }
        //desac autres spells

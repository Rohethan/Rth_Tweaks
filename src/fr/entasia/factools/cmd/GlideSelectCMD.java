...
public class GlideSelectCMD implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (p.hasMetadata("spellGlide")) {
            ...
            p.sendMessage("(§2Spells§f) Fly §4désactivé");
        } else {
            p.setMetadata("spellGlide", new FixedMetadataValue(Main.main, true));
            p.sendMessage("(§2Spells§f) Fly §2activé");
        }
        // desac autre spells
